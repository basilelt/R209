...
def index(request):
    return render(request, 'bibliotheque/livre/index.html')
...
def ajout(request):
    if request.method == "POST":    # Arrive en cas de retour sur cette page après une saisie invalide on récupère donc les données.
        ...
        if form.is_valid(): # validation du formulaire.
            ...
            return render(request,"bibliotheque/livre/affiche.html",{"livre" : livre}) # Envoie vers une page d'affichage du livre créé
        else:
...
def all(request):
    ...
    return render(request,"bibliotheque/livre/all.html",{"all": all})
...
def update(request, id):
    ...
    return render(request,"bibliotheque/livre/update.html",{"form": lform, "livre": livre})
...
def traitementupdate(request, id):
    ...
    if lform.is_valid():
        ...
        return HttpResponseRedirect("/bibliotheque/livre/all") # plutot que d'avoir un gabarit pour nous indiquer que cela c'est bien passé,
...
def delete(request, id):
    livre = models.Livre.objects.get(pk=id)
    livre.delete()
    return HttpResponseRedirect("/bibliotheque/livre/all")